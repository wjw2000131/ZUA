    ...
    with torch.no_grad():
        ...
        for device, alloc in zip(devices, allocation):
            for _ in range(alloc):
                # gradinator : images[cur_idx].to(device).requires_grad = False
